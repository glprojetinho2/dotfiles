...
paru -S --needed --noconfirm python-pip python python-pipx python-i3ipc anki-bin syncthing ripgrep alacritty lldb rustup git-credential-oauth pipewire pipewire-pulse pwvucontrol lazygit tealdeer kdotool nemo wmenu polkit sway jq swaylock-effects-git grim slurp zoxide blesh fish fisher torbrowser-launcher tor bemenu-wlroots qutebrowser calibre || { echo "falha ao instalar pacotes essenciais"; exit 1; }
pipx install jrnl
tldr --update
